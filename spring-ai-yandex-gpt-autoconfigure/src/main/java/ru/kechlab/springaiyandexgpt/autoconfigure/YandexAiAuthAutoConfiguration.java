...
import ru.kechlab.springaiyandexgpt.api.ApiKeyAuthorizationProcessor;
import ru.kechlab.springaiyandexgpt.api.AuthorizationProcessor;
import ru.kechlab.springaiyandexgpt.api.IamTokenAuthorizationProcessor;
...
import ru.kechlab.springaiyandexgpt.autoconfigure.wrappers.AuthPropertiesWrapper;
import ru.kechlab.springaiyandexgpt.text.YandexAiChatApi;

/**
 * Registers a single {@link ru.kechlab.springaiyandexgpt.api.AuthorizationProcessor} bean from
 * {@link ru.kechlab.springaiyandexgpt.autoconfigure.properties.AuthProperties}: IAM token (optionally
