...
import ru.kechlab.springaiyandexgpt.autoconfigure.properties.ChatProperties;
...
/**
 * Auto-configures {@link YandexAiChatApi} and
 * {@link ru.kechlab.springaiyandexgpt.text.YandexAiChatModel} when Spring AI's chat model provider is
