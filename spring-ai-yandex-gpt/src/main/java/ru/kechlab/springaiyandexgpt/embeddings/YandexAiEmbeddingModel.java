...
import ru.kechlab.springaiyandexgpt.dto.EmbeddingApi.EmbeddingRequestSpec;
...
public class YandexAiEmbeddingModel extends AbstractEmbeddingModel {
    ...
    /**
     * Embeds the request using the given {@link ru.kechlab.springaiyandexgpt.constants.EmbeddingModel}
    ...
    protected EmbeddingRequestSpec buildRequest(EmbeddingRequest request, ru.kechlab.springaiyandexgpt.constants.EmbeddingModel model) {
