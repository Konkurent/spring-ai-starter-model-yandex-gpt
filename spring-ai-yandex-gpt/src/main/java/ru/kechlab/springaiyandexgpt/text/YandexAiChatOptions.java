...
public class YandexAiChatOptions implements StructuredOutputChatOptions {
    ...
    public YandexAiChatOptions merge(YandexAiChatOptions other) {
        ...
        if (other.getChatModel() != null) {
            mutator.model(other.getChatModel());
        }
    ...
    public String getModel() {
        return chatModel != null ? chatModel.getName() : null;
    }
    ...
    public static class Builder {
        ...
        Builder(YandexAiChatOptions completionOptions) {
            this.chatModel = completionOptions.getChatModel();
        ...
        public YandexAiChatOptions build() {
            return new YandexAiChatOptions(this.chatModel, this.folderId, this.temperature, this.outputClass, this.outputSchema, this.maxTokens, this.reasoningMode, this.httpHeaders, this.stopSequences);
        }

        public String toString() {
            return "YandexGptChatOptions.Builder(completionModel=" + this.chatModel + ", temperature=" + this.temperature + ", outputClass=" + this.outputClass + ", outputSchema=" + this.outputSchema + ", maxTokens=" + this.maxTokens + ", stopSequences=" + this.stopSequences + ")";
        }
