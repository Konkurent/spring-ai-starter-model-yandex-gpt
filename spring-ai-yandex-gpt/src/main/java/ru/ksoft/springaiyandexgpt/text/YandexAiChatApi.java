...
/**
 * Low-level REST client for Yandex chat completions: blocking {@link org.springframework.web.client.RestClient}
 * for normal responses and {@link org.springframework.web.reactive.function.client.WebClient} for streaming.
 * <p>
 * All requests pass through the configured {@link ru.ksoft.springaiyandexgpt.api.HeadersProcessor} list
